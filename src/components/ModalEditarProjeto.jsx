...
const ModalEditarProjeto = ({ onClose, onSave, projetoParaEditar }) => {
  ...
  useEffect(() => {
    if (projetoParaEditar) {
      setFormData({
        ...
        numero: projetoParaEditar.numero || '',
        centroCusto: projetoParaEditar.centroCusto || ''
      });
    }
  }, [projetoParaEditar]);
  ...
  return (
    <div className="fundo-modal-editarProjeto">
      <div className="caixa-modal-editarProjeto">
        <button className="fechar-modal-editarProjeto" onClick={onClose}>×</button>
        <h2 className="titulo-modal-editarProjeto">Editar Projeto</h2>
        ...
        <form onSubmit={handleSubmit} className="form-modal">
          ...
          <div className="acoes-form">
            <button 
              type="submit" 
              className="btn-salvar-editarprojeto"
            >
              Salvar Alterações
            </button>
            <button 
